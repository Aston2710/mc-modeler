---
id: EXP-007
titulo: Aparecian flechas duplicadas por divergencia del id de conexion entre clientes
estado: resuelto
severidad: alta
fecha_deteccion: por-determinar
fecha_cierre: por-determinar
componentes: [YjsBpmnBinding.ts, yBpmnModel.ts]
relacionados: []
---

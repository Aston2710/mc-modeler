---
id: EXP-010
titulo: Mover un pool, carril o grupo rerutaba las flechas internas
estado: resuelto
severidad: alta
fecha_deteccion: 2026-07-27
fecha_cierre: 2026-08-09
componentes: [src/bpmn/connections/BizagiLayouter.ts, src/bpmn/connections/OrthogonalityBehavior.ts, src/bpmn/connections/containers.ts]
relacionados: [context/patrones-routing.md, MASTER-PLAN-018]
---

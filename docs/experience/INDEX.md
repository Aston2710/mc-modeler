...
| [EXP-010](010-mover-contenedor-reruta-las-flechas-internas.md) | Mover el pool a la derecha reruta las flechas internas | **activo** | alta | `src/bpmn/connections` | 2026-07-27 |
...
Tres abiertos: EXP-010, EXP-011 y EXP-012. **EXP-011 es el único que destruye trabajo del usuario** y su mitigación es [PLAN-014](../plans/todo/014-mitigacion-perdida-de-trabajo-en-colaboracion.md), la prioridad máxima antes de producción.

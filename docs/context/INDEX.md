...
| [desarrollo-local.md](desarrollo-local.md) | Entorno local en Docker (`npm run lab`): dónde se prueban los cambios de esquema antes de producción | vigente | 2026-08-13 |
